...
// Função que valida aceitando apenas numeros no campo 

    //$('.sonums').keypress(function(event) {
    $.fn.validar.fn.SomenteNumero = function(event, params){
...
//$.fn.validar.fn.SomenteNumero = function(el){
//    var valor = $(el).val();
//    alert(parseInt(valor));
//    if((parseInt(valor)>47 && parseInt(valor)<58)) 
//        return true;
//    else{
//        if (parseInt(valor) == 8 || parseInt(valor) == 0) 
//            return true;
//            else 
//                return false;
//    }
